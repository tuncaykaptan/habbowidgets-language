...
return [
    ...
    "Birthdays in Habbo." => "Habbo'da doğum günüleri.",
    "Do you know anyone?" => "Bunlardan birini tanıyor musun?",
    "There are no birthdays in this hotel as far as we know?" => "Bildiğimiz kadarıyla bu otelde doğum günü olan yok.",
    "Pick another date" => "Başka bir tarih seç",
    "All years" => "Bütün Yıllar",
    "You have supplied an invalid date" => "Geçersiz bir tarih girdiniz",
    "This date lies in the future and can not be used" => "Gelecekten bir tarih seçilemez",

    // Habinfo Form
    "Find Habinfo on.." => "Habinfoyu buradan bulabilirsin..",
    "Find" => "Bul", // Button on the Habinfo form
    "Tip" => "İpucu",
    "Did you know you can also use a Direct URL to get to the Habbo you want to find?" => "Bunu biliyormuydun? Bir Habbo'yu direkt Link kullanarak bulabilirsin!",
    "Just use the following format" => "Bunu kullan",
    "This hotel does not exist" => "Böyle bir otel bulunmamakta",
    ...
    "Something went wrong, we couldn't find that Habbo. Or they are banned.." => "Bir şeyler yanlış gitti.. bu Habboyu bulamadık veya yasaklanmış..",
    "Return to the Habinfo widget" => "Habinfo araçına geri dön",
    "Visit Habinfo history" => "Habboinfo hikayesini ziyaret et",
    ...
    "Rating" => "Puanlama",
    "Maximum visitors" => "Odanın toplam ziyaretçisi",
